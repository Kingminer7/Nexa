...
fetch("https://discord.com/api/users/@me/guilds", {
  ...
  .then((guilds) => {
	...
	if(guilds.message == "You are being rate limited.") {
		alert("Please stop reloading the page. You are being rate limited by Discord. You will be redirected soon.")
		setTimeout(() => {
    ...
    manageableGuilds.forEach((guild) => {
      ...
      option.value = `https://discord.com/channels/${guild.id}`;
